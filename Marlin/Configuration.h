...
#define STRING_CONFIG_H_AUTHOR "(ctag)" // Who made the changes.
...
#ifdef PIDTEMPBED
// 200W silicon pad heater on aluminum plate
    #define  DEFAULT_bedKp 151.68
    #define  DEFAULT_bedKi 18.52
    #define  DEFAULT_bedKd 310.64
